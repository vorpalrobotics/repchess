...
*/
import { openAssetPicker } from './assets.js?v=20260804-96';
import { openNewObjectListModal } from './objectLists.js?v=20260804-73';
...
function buildHelpOverlay(){
  ...
  ov.innerHTML = `
    <div style="background:#fff;color:#222;max-width:32em;width:88%;max-height:84%;overflow:auto;
      ...
      <p style="margin:.4rem 0"><strong><i class="fa-solid fa-book-open"></i> Room story:</strong> the icon in the lower-right corner reads and edits this room's story. It looks different when the room has no story yet.</p>
      <p style="margin:.4rem 0"><strong><i class="fa-solid fa-chess-board"></i> Move-pair notes:</strong> walk close to a move pair and look at it, and a small board icon appears on its corner. Click it to see that position with its note and story, and edit either one. A scroll beside a dead-end sign means the line's last move has a note.</p>
