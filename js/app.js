...
import { openThreeTest, closeThreeTest, refreshAssetsLive, setForeignModalOpen, jumpToRoom, refreshRoomStoryIcon } from './threeVR.js?v=20260804-327';
import { openAssetManager, closeAssetManager, cropImage, fileToDataUrl, webpEncodeSupported, toWebpDataUrl,
         openImageQueue, resetImageQueue } from './assets.js?v=20260804-98';
import { modalBarHtml, wireModalBar } from './modalBar.js?v=20260804-5';
import { openObjectListManager, closeObjectListManager, importObjectListsData, isObjectListFile, setCastleInfoProvider, openCastleQuizPicker } from './objectLists.js?v=20260804-76';
...
const BACKUP_EXCLUDED_META = {
  ...
  listIdeas: 'object-list suggestions from AI brainstorms not yet used (js/listBrainstorm.js) -- like unreviewed images, not worth carrying in a backup; a restore discards them',
};
...
function rfPacingHtml(f){
  ...
  const pacing = t.moves
    ? `A room you memorize today gets a same-day review a few hours later, then comes due <b>tomorrow</b>, on top of the
